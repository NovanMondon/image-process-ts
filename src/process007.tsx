...
export function Process007({ tImage, setResultURL }: ImageProcessUtilityProps) {
    const mean_pooling = ImageProcessUtility({ tImage, setResultURL }, (aImage: ProcessedImage) => {
        const tGridSize = 8
